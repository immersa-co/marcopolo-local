# Marcopolo local deployment

MarcoPolo local deployment on Colima. Open Marcopolo at http://localhost:8000 and Grafana at http://localhost:3000.
...
Ensure that you keep the key, passphrase, and token outside the repository.
